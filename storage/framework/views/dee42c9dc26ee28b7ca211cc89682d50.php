...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
            ...
            <div x-show="activeSlide === 0" x-transition:enter="transition ease-out duration-500"
                ...
                <div
                    ...
                    <div class="md:w-1/2 text-center md:text-left z-10">
                        ...
                        <div class="mt-8">
                            <a href="<?php echo e(isset($neakasa) ? route('product.show', $neakasa) : '#'); ?>"
            ...
            <div x-show="activeSlide === 1" x-transition:enter="transition ease-out duration-500"
                ...
                <div
                    ...
                    <div class="md:w-1/2 text-center md:text-left z-10">
                        ...
                        <a href="<?php echo e(route('brand.show', ['brand' => 'Pedigree'])); ?>"
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <h2 class="text-2xl font-bold text-gray-900 mb-6">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($brand)): ?>
                <?php echo e(ucfirst($brand)); ?> Products
            <?php elseif(isset($pet) && isset($category)): ?>
                <?php echo e(ucfirst($pet)); ?> - <?php echo e(str_replace('_', ' ', ucfirst($category))); ?>
...
[$__name, $__params] = $__split('product-list', ['pet' => $pet ?? null,'category' => $category ?? null,'brand' => $brand ?? null]);

$key = null;
$__componentSlots = [];

$key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-1452601078-0', $key);
...
<?php endif; ?><?php /**PATH C:\New folder\SSP_2_final\petmart2\resources\views/welcome.blade.php ENDPATH**/ ?>