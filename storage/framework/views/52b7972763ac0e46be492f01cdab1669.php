...
<head>
    ...
    <title><?php echo e(config('app.name', 'PetMart')); ?></title>
                        ...
                        <div x-show="open" x-transition:enter="transition ease-out duration-200"
                            ...
                            <div class="relative group" x-data="{ subOpen: false }" @mouseenter="subOpen = true"
                                ...
                                <div x-show="subOpen"
                                    ...
                                    <a href="<?php echo e(route('shop.filtered', ['pet' => 'dog', 'category' => 'dry_food'])); ?>"
                                        wire:navigate
                                        class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 hover:text-primary">Dry
                                        Food</a>
                                    <a href="<?php echo e(route('shop.filtered', ['pet' => 'dog', 'category' => 'wet_food'])); ?>"
                            ...
                            <div class="relative group" x-data="{ subOpen: false }" @mouseenter="subOpen = true"
                                ...
                                <div x-show="subOpen"
                                    class="absolute left-full top-0 w-48 bg-white rounded-md shadow-lg py-1 ring-1 ring-black ring-opacity-5 -ml-1">
                                    <a href="<?php echo e(route('shop.filtered', ['pet' => 'cat', 'category' => 'dry_food'])); ?>"
                                        class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 hover:text-primary">Dry
                                        Food</a>
                                    <a href="<?php echo e(route('shop.filtered', ['pet' => 'cat', 'category' => 'wet_food'])); ?>"
                                        class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 hover:text-primary">Wet
                                        Food</a>
                                </div>
                            </div>
...
$key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-3876025459-0', $key);
...
?>
                    <div class="relative">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->guard()->check()): ?>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->user()->is_admin): ?>
                                <a href="<?php echo e(route('admin.dashboard')); ?>" class="text-red-600 hover:text-red-800 font-bold"
                            ...
                            <?php else: ?>
                                <a href="<?php echo e(route('user.dashboard')); ?>" wire:navigate class="text-gray-600 hover:text-primary"
                                    title="My Account">
                                    <svg class="h-6 w-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            ...
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        <?php else: ?>
                            <a href="<?php echo e(route('login')); ?>" wire:navigate class="text-gray-600 hover:text-primary">
                                <svg class="h-6 w-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                                </svg>
...
$key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-3876025459-1', $key);
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
                ...
                <div>
                    ...
                    <ul class="space-y-3 text-sm text-gray-400">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if (! (auth()->user()?->is_admin)): ?>
                            <li><a href="<?php echo e(route('about')); ?>" class="hover:text-primary transition-colors">About Us</a>
                            </li>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            ...
            <div class="border-t border-gray-800 pt-8 text-center">
                <p class="text-sm text-gray-500">&copy; <?php echo e(date('Y')); ?> PetMart. All rights reserved.</p>
            </div>
        </div>
    </footer>
</body>

</html><?php /**PATH C:\New folder\SSP_2_final\petmart2\resources\views/layouts/guest.blade.php ENDPATH**/ ?>