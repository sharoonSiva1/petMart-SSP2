                                ...
                                @foreach($pendingOrders as $order)
                                    <li class="p-4 hover:bg-gray-50 transition">
                                        <div class="flex justify-between">
                                            <div>
                                                <p class="text-sm font-medium text-primary">Order #{{ $order->id }}</p>
                                                ...
                                                <button wire:click="viewOrder({{ $order->id }})"
                                                    ...
                                                    Details</button>
                                                <button wire:click="cancelOrder({{ $order->id }})" wire:confirm="Are you sure you want to cancel this order?"
                            ...
                            <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                                ...
                                <div class="mt-4">
                                    ...
                                    <p class="text-sm text-gray-600 mb-4">Status: <span
                                            class="capitalize font-bold">{{ $selectedOrder->status }}</span></p>

                                    @if($selectedOrder->status === 'cancelled' && $selectedOrder->cancelled_by === 'admin')
