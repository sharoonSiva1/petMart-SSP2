            ...
            <div class="bg-white shadow overflow-hidden sm:rounded-lg">
                        ...
                        <li class="p-6 flex items-center">
                            ...
                            <div class="flex-shrink-0 w-24 h-24 border border-gray-200 rounded-md overflow-hidden">
                                <img src="{{ $item['product']->image ?? 'https://via.placeholder.com/150' }}"
                                    alt="{{ $item['product']->name }}" class="w-full h-full object-center object-cover">
                            </div>
                            ...
                            <div class="ml-4 flex-1 flex flex-col sm:flex-row sm:justify-between sm:items-center">
                                <div>
                                    ...
                                    <p class="mt-1 text-sm text-gray-500">{{ Str::limit($item['product']->description, 50) }}
                                    </p>
                                    <p class="mt-1 text-sm font-medium text-gray-900">Rs
                                        {{ number_format($item['product']->price * 300, 2) }}
                                    </p>
                                </div>
                                ...
                                <div class="mt-4 sm:mt-0 sm:ml-6 text-right">
                                    <p class="text-lg font-bold text-gray-900">Rs
                                        {{ number_format($item['subtotal'] * 300, 2) }}
                                    </p>
                                </div>
                            </div>
                        </li>
                ...
                <div class="bg-gray-50 px-6 py-6 border-t border-gray-200">
                    <div class="flex justify-between items-center mb-2">
                        ...
                        <div class="text-lg font-bold text-gray-900">Rs {{ number_format($total * 300, 2) }}</div>
                    </div>
                    <div class="flex justify-between items-center mb-2">
                        <div class="text-base font-medium text-gray-500">Shipping Fee</div>
                        <div class="text-lg font-bold text-gray-900">Rs {{ number_format($shippingFee_calc, 2) }}</div>
                    </div>
                    <div class="flex justify-between items-center pt-4 border-t border-gray-200">
                        <div class="text-xl font-bold text-gray-900">Total</div>
                        <div class="text-2xl font-bold text-primary">Rs
                            {{ number_format(($total * 300) + $shippingFee_calc, 2) }}
                        </div>
                    </div>
                </div>
